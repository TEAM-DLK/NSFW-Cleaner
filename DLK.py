...
# Detector weights
NUDE_WEIGHT = float(os.getenv("NUDE_WEIGHT", "1.0"))
OPENNSFW2_WEIGHT = float(os.getenv("OPENNSFW2_WEIGHT", "0.6"))
CLIP_WEIGHT = float(os.getenv("CLIP_WEIGHT", "0.45"))
POSE_WEIGHT = float(os.getenv("POSE_WEIGHT", "0.25"))
YAHOO_WEIGHT = float(os.getenv("YAHOO_WEIGHT", "0.5"))

# per-model thresholds (not strictly required; used for heuristics)
OPENNSFW2_THRESHOLD = float(os.getenv("OPENNSFW2_THRESHOLD", "0.70"))
CLIP_THRESHOLD = float(os.getenv("CLIP_THRESHOLD", "0.60"))
POSE_THRESHOLD = float(os.getenv("POSE_THRESHOLD", "0.5"))
YAHOO_THRESHOLD = float(os.getenv("YAHOO_THRESHOLD", "0.7"))
