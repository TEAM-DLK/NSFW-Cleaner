...
SUGGESTIVE_LABELS = {
'NUDITY_BELOW_WAIST', 'NUDITY_ABOVE_WAIST', 'EXPLICIT_CLOSEUP', 'SEXUAL_EXPRESSION', 'SEXUAL_CONTACTS',
'SEXUAL_ACT_PERFORMED', 'EROTIC_ACTIVITY', 'EROTIC_SCENE', 'SEXUAL_SCENE_EXPLICIT', 'INTENSE_SEX_SCENE',
'NUDE_SITTING', 'NUDE_LYING', 'NUDE_STANDING', 'NUDE_POSE', 'NUDE_SELFIE', 'NUDE_GROUP', 'NUDE_COUPLE',
'PORNSTAR_ACTIVITY', 'PORNSTAR_PHOTO', 'PORNSTAR_VIDEO', 'ADULT_MOVIE', 'ADULT_STREAM', 'ADULT_BROADCAST',
'CAM_MODEL', 'CAM_STREAM', 'WEBCAM_SEX', 'WEB_CAM_EXPLICIT', 'SEXUAL_CAM', 'STRIP_SHOW', 'PRIVATE_SHOW',
'SEXUAL_PERFORMANCE', 'SEXUAL_SHOW', 'X_RATED', 'R_RATED_SEX', 'SEXUALLY_EXPLICIT_VIDEO', 'SEXUALLY_EXPLICIT_IMAGE',
'SEXUALLY_EXPLICIT_PHOTO', 'NUDE_PHOTO', 'NUDE_VIDEO', 'NUDE_IMAGE', 'NUDITY_PHOTO', 'NUDITY_VIDEO', 'NUDITY_IMAGE',
'EXPOSED_BODY', 'EXPOSED_CHEST', 'EXPOSED_LOWER_BODY', 'EXPOSED_UPPER_BODY', 'EXPOSED_SKIN', 'EXPOSED_PRIVATE_PARTS',
'EXPOSED_SELF', 'EXPOSED_OTHERS', 'SEXUALIZED_PHOTOGRAPHY', 'SEXUALIZED_MEDIA', 'SEXUALIZED_PICTURE', 'LEWD_PHOTO',
'LEWD_VIDEO', 'LEWD_IMAGE', 'LEWD_PHOTOGRAPH', 'OBSCENE_PHOTO', 'OBSCENE_VIDEO', 'OBSCENE_IMAGE',
}
